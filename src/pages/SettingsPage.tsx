          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea defaultValue="ISKCON Temple Book Stall" />
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium">{t('settings.receiptSettings.footer')}</label>
                <Textarea defaultValue="Thank you for your purchase! Hare Krishna!" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea defaultValue="Hare Krishna! Thank you for supporting ISKCON Temple." />
              </div>
            </CardContent>
            <CardFooter>
              <Button>
